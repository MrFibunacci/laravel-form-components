...
return [
     ...
     * Success status will be displayed when errors are sent to the view with no matching with the component name.
     */
     ...
     * Fail status will be displayed when errors are sent to the view with a match with the component name.
     */
